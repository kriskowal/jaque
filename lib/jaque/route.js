...
exports.Node = function (app, notFound) {
    return exports.ComponentMap({"": app}, notFound);
};

exports.ComponentMap = function (paths, notFound) {
    if (!paths)
        paths = {};
    if (!notFound)
...
exports.Content = function (body, contentType) {
    return function (request) {
        return {
            "status": 200,
            "headers": {
...
exports.Json = function (app) {
    // XXX TODO parse query string for formatting options
