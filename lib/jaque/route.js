...
var MIME = require("narwhal/mime");
var UUID = require("narwhal/uuid");
            ...
            if (
                ...
                return Q.when(response.body, function (body) {
                    if (Array.isArray(body)) {
                        return Q.when(Q.all(body), function (body) {
                            response.body = body;
                            response.headers["content-length"] = 
...
exports.CookieSession = function (Session) {
    ...
    return function (request) {
        ...
        // new session
            ...
            var response = exports.TemporaryRedirect(request.location + "~session/")(request);
